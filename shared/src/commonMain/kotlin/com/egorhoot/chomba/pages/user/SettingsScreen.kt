    ...
    Surface(
        ...
        Column(
            ...
            NameHorizontalDivider(
                text = stringResource("speech_rec_idioma"),
                modifier = Modifier.fillMaxWidth(),
                textStyle = MaterialTheme.typography.titleMedium
            )
//            Text(
//                text = stringResource(id = stringResource(.speech_rec_idioma),
...
//            )
            ...
            NameHorizontalDivider(
                text = stringResource("player_settings"),
                modifier = Modifier.fillMaxWidth(),
                textStyle = MaterialTheme.typography.titleMedium
            )
    ...
    Column(
        ...
        Row(
            ...
            OutlinedTextField(
                ...
                placeholder = { Text(stringResource("nickname")) },
        ...
        BasicIconButton(
            text = stringResource("merge_player"),
