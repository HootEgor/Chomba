...
fun LoginScreen(
    ...
    val onGoogleSignInClick = {
        val apiKey = profileViewModel.stringResource("default_web_client_id")
...
//                .padding(8.dp),
//            singleLine = true,
//            placeholder = { Text(stringResource(stringResource(.email)) },
...
//            },
//        ) {
//            Text(text = stringResource(stringResource(.sign_in_with_email))
//        }
//
//        Spacer(modifier = Modifier.height(16.dp))
        ...
        TextButton(
            ...
            Text(text = stringResource("sign_in_with_google"))
        }
