...
import chomba.shared.generated.resources.baseline_delete_24
import chomba.shared.generated.resources.baseline_trending_down_24
import chomba.shared.generated.resources.baseline_trending_up_24
import chomba.shared.generated.resources.baseline_visibility_off_24
    ...
    Box(
        ...
        Surface(
            ...
            Column(
                ...
                if (blind && zeroNum == 0) {
                    Image(
                        painter = painterResource(Res.drawable.baseline_visibility_off_24),
                ...
                LazyRow(
                    ...
                    items(zeroNum) {
                        Image(
                            painter = painterResource(Res.drawable.ic_1200952),
                            contentDescription = null,
                            modifier = Modifier.size(16.dp),
                        )
                    }
...
class PolygonShape(
    ...
    override fun createOutline(
        ...
        for (i in 0 until sides) {
            val angle = ((360.0 / sides) * i - 90.0 + rotationAngle) * (PI / 180.0)
    ...
    Canvas(modifier = modifier.fillMaxSize()) {
        ...
        fun buildPolygonPath(
            ...
            val vertices = (0 until numberOfSides).map { i ->
                val angle = ((360.0 / numberOfSides) * i - 90.0 + rotationAngle) * (PI / 180.0)
                Offset(
    ...
    Surface (
        ...
        Column(
                    ...
                    Row(
                        ...
                        for (suit in CardSuit.entries){
                            Column(
                                ...
                                Icon(
                                    painter = painterResource(suitIcon(suit.ordinal)),
                                    contentDescription = null,
            ...
            AnimatedVisibility(visible = selected && editable) {
                Column {
                    IconButton(icon = Res.drawable.baseline_border_color_24,
                        modifier = modifier
                            .fillMaxWidth()
                            .padding(8.dp, 0.dp, 8.dp, 0.dp),
                        action = onEdit)
                    IconButton(icon = Res.drawable.baseline_delete_24,
                        modifier = modifier
                            .fillMaxWidth()
