...
val loader = object : Font.ResourceLoader {
//    override suspend fun load(path: String): ByteArray {
//        // Load your bytes from shared resources
//        return Res.readBytes(path)
//    }

    override fun load(font: Font): Any {
        // Minimal stub for fonts
        // On Android/iOS you might return a platform-specific font
        return Unit
    }
}

fun DrawScope.drawScoreLines(
    lineColor: Color,
    value: Int,
    thickness: Float,
    min: Int
    ...
    // <-- use drawContext.fontFamilyResolver (available in newer Compose MPP)
//    val paragraphIntrinsics = ParagraphIntrinsics(
//        text = text,
//        style = textStyle,
//        spanStyles = emptyList<AnnotatedString.Range<SpanStyle>>(),
//        placeholders = emptyList<AnnotatedString.Range<Placeholder>>(),
//        density = this,
//        fontFamilyResolver = drawContext.fontFamilyResolver
//    )
    ...
    val centerX = (size.width - paragraph.width) / 2f
    val textY = y - paragraph.height / 2f
